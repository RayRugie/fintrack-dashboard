...
const Sidebar: React.FC<SidebarProps> = React.memo(({ isOpen, onClose }) => {
  return (
    <>
      ...
      <div
        className={clsx(
          'fixed inset-0 bg-neutral-500 bg-opacity-50 z-40 lg:hidden transition-opacity duration-300',
      ...
      <aside
        className={clsx(
          'fixed top-0 left-0 h-full w-64 bg-white z-50 flex flex-col transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:z-auto',
