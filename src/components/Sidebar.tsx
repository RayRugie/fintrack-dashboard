...
const Sidebar: React.FC<SidebarProps> = React.memo(({ isOpen, onClose }) => {
  return (
    <>
      <div
        className={clsx(
          'fixed inset-0 bg-black bg-opacity-30 z-40 lg:hidden transition-opacity duration-300',
      ...
      <aside
        className={clsx(
          'fixed top-0 left-0 h-full w-64 bg-white shadow-lg z-50 flex flex-col transform transition-transform duration-300 lg:translate-x-0 lg:static lg:shadow-none',
